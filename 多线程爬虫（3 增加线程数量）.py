...
if __name__ == "__main__":
    ...
    # t3 = threading.Thread(target=prase_detail, args=(detail_tasks,))
    # t4 = threading.Thread(target=prase_detail, args=(detail_tasks,))
    # t5 = threading.Thread(target=prase_detail, args=(detail_tasks,))
    # t6 = threading.Thread(target=prase_detail, args=(detail_tasks,))
    # t7 = threading.Thread(target=prase_detail, args=(detail_tasks,))
    t1.start()
    for i in tasks_list:
        i.start()
